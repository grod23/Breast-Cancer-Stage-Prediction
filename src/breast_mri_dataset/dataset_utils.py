...
def get_train_split():
    ...
    X_train = [seq['image_paths'] for seq in sequences if seq['patient_id'] in X_train_ids]
    X_test = [seq['image_paths'] for seq in sequences if seq['patient_id'] in X_test_ids]
